...
class LeonCog(commands.Cog):
    ...
    @commands.group(name='4top')
    async def _4top(self, ctx):
        pass
    ...
    @_4top.command()
    async def threads(self, ctx, board):
        pass

    @_4top.command()
    async def posts(self, ctx, board):
        pass

    @_4top.command()
    async def pics(self, ctx, board):
        pass
